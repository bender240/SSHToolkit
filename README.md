...
modify CIDR.txt with your CIDR
...
FEATURES:
Run hydra in the background with large wordlists , attack multiple targets, run MITM sessions and dictionary attacks simultaneously. Run nmap scans on CIDRs, add targets.
